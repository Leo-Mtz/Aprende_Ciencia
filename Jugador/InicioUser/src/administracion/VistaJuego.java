...
public class VistaJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Consulta de juegos");

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));

        Otros.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Menos Partidas", "Mas Partidas" }));
    ...
    private void btnimprimir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnimprimir1ActionPerformed
        GraficaJuegoPartidas a= new GraficaJuegoPartidas(users);
        this.dispose();
        a.setVisible(true);
    ...
    public void otros(){
        ...
        if("Menos Partidas".equals(a)){
            DefaultTableModel modelo= new DefaultTableModel();
            users.MenorPartidas();
            modelo=users.Enviar();
            tabla.setModel(modelo);
        }
        if("Mas Partidas".equals(a)){
            DefaultTableModel modelo= new DefaultTableModel();
            users.MasPartidas();
            modelo=users.Enviar();
            tabla.setModel(modelo);
