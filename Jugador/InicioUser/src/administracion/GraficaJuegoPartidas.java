 ...
 * @author jesus
 */
public class GraficaJuegoPartidas extends javax.swing.JFrame {

Juegos users=new Juegos();
    
    public GraficaJuegoPartidas(Juegos users) {
        initComponents();
        this.users=users;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraficaJuegoPartidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraficaJuegoPartidas().setVisible(true);
            }
        });
    }
    ...
    private void agregargrafico() {
        ArrayList<ArrayJuegos> an=users.a;

        DefaultCategoryDataset datos= new DefaultCategoryDataset();
        
        
        for(int i=0;i<an.size();i++){
            datos.setValue(an.get(i).Partidas, "PARTIDAS", an.get(i).Nombre);
        }
