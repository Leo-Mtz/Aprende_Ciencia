 ...
 * @author DELL
 */
public class P3Medio extends javax.swing.JFrame {
    ...
    public P3Medio(int puntajeRecibido, int pistasUsadasActual,int id) {
    this.id=id;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿ Qué planeta tarda la mayor cantidad de");
        ...
        jLabel1.setText("tiempo en darle la vuelta al sol");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, 280, 40));

        btntierra.setBackground(new java.awt.Color(0, 0, 0));
        btntierra.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btntierra.setForeground(new java.awt.Color(255, 255, 255));
        btntierra.setText("Tierra");
        btntierra.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 255)));
        btntierra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btntierraActionPerformed(evt);
            }
        });
        getContentPane().add(btntierra, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 120, 40));
        ...
        botoncorrecto.setBackground(new java.awt.Color(0, 0, 0));
        botoncorrecto.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        botoncorrecto.setForeground(new java.awt.Color(255, 255, 255));
        botoncorrecto.setText("Neptuno");
        botoncorrecto.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 255)));
        botoncorrecto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botoncorrectoActionPerformed(evt);
            }
        });
        getContentPane().add(botoncorrecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, 120, 30));
        ...
        jTextField1.setEditable(false);
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 70, -1));
    ...
    private void btntierraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntierraActionPerformed
        ...
        P4Medio pregunta4 = new P4Medio(puntaje,pistasUsadas,id);
    ...
    private void correctaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_correctaActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Es el octavo planeta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P3Medio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
