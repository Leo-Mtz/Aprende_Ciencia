 ...
 * @author DELL
 */
public class P7Medio extends javax.swing.JFrame {
    ...
    public P7Medio(int puntajeRecibido, int pistasUsadasActual,int id) {
    this.id=id;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿ Cuántos satelites  naturales tiene ");
        jLabel2.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, 420, 40));

        jLabel3.setBackground(new java.awt.Color(255, 0, 255));
        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("la Tierra?");
        jLabel3.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, 280, 40));
        ...
        getContentPane().add(correct, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 120, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 170, 130, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, 130, 30));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 15, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Trivia/Medio/fondo.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 514, 320));
    ...
    private void correctActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_correctActionPerformed
        ...
        P8Medio pregunta8 = new P8Medio(puntaje,pistasUsadas,id);
    ...
    private void pistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pistaActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Recuerdas la luna ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P7Medio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
