 ...
 * @author DELL
 */
public class P6Dificil extends javax.swing.JFrame {
    ...
    public P6Dificil(int puntajeRecibido, int pistasUsadasActual,int id) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Una supernova es una explosión estelar");
        jLabel3.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 420, 50));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 120, 40));
        ...
        getContentPane().add(correct, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 190, 120, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        P7Dificil pregunta7 = new P7Dificil(puntaje,pistasUsadas,id);
    ...
    private void pistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pistaActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Eso le pasara al Sol");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P6Dificil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
