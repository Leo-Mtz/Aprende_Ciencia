...
import static PuzzleMenu.Medio.SistemaSolarMedio.PuzzleSistemaSolarMedio.id;
...
public class Figure extends JButton implements ActionListener{
	...
	private void Move(){
		...
		if(board[xPos][yPos-1].getFigure() == null){ // arriba
			...
			yPos --;
			PuzzleSistemaSolarMedio.board.Remover();
			ComprobarRespuesta();
			return;
	...
	private void ComprobarRespuesta(){
		...
		// completado
                ...
                NuevaPartida nuevarompecabezas= new NuevaPartida(id, 2,35);
		JOptionPane.showMessageDialog(new JPanel(), "Felicitaciones", "Rompecabezas Terminado", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(new JPanel(), "El Sistema Solar tiene cerca de 4,6 mil millones de años !", "Aprendizaje", JOptionPane.INFORMATION_MESSAGE);
