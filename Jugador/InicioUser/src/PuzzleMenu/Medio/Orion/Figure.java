 ...
 */
package PuzzleMenu.Medio.Orion;
import Perfil.NuevaPartida;
import static PuzzleMenu.Medio.Orion.PuzzleOrion.id;
...
public class Figure extends JButton implements ActionListener{
	...
	private void ComprobarRespuesta(){
		...
		// completado
                ...
                NuevaPartida nuevarompecabezas= new NuevaPartida(id, 2,5);
		JOptionPane.showMessageDialog(new JPanel(), "Felicitaciones", "Rompecabezas Terminado", JOptionPane.INFORMATION_MESSAGE);
                
		JOptionPane.showMessageDialog(new JPanel(), "Basada en un mito griego, la constelación de Orion\n contiene una de las estrellas más brillantes en el cielo", "Aprendizaje", JOptionPane.INFORMATION_MESSAGE);
