 ...
 */
package PuzzleMenu.Medio.Apollo;

import Perfil.NuevaPartida;
import static PuzzleMenu.Medio.Apollo.PuzzleApollo.id;
...
public class Figure extends JButton implements ActionListener{
	...
	private void ComprobarRespuesta(){
		...
		JOptionPane.showMessageDialog(new JPanel(), "Felicitaciones", "Rompecabezas Terminado", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(new JPanel(), "El Apollo 11 despego en Julio de 1969, y fue el primer viaje exitoso a la luna", "Aprendizaje", JOptionPane.INFORMATION_MESSAGE);
