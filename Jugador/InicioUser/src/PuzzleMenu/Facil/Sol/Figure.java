...
import static PuzzleMenu.Facil.Sol.PuzzleSol.id;
...
public class Figure extends JButton implements ActionListener{
	...
	private void ComprobarRespuesta(){
		...
		JOptionPane.showMessageDialog(new JPanel(), "Felicitaciones", "Rompecabezas Terminado", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(new JPanel(), "El Sol es la estrella de nuestro Sistema, y esta compuesto de hidrogeno y helio", "Aprendizaje", JOptionPane.INFORMATION_MESSAGE);
