...
import static PuzzleMenu.Facil.SistemaSolar.PuzzleSistemaSolarFacil.id;
...
public class Figure extends JButton implements ActionListener{
	...
	private int dimension;
        ...
        private JFrame currentPuzzleWindow;
        ...
        public Figure(int xSolPos, int ySolPos, ImageIcon subimage, int dimension, int id) {
            ...
            this.puzzleMenu = puzzleMenu;
            this.currentPuzzleWindow = currentPuzzleWindow;
    }
	...
	private void Move(){
		...
		if(board[xPos][yPos-1].getFigure() == null){ // arriba
			...
			yPos --;
			PuzzleSistemaSolarFacil.board.Remover();
			ComprobarRespuesta();
			return;
	...
	private void ComprobarRespuesta(){
		...
		JOptionPane.showMessageDialog(new JPanel(), "Felicitaciones", "Rompecabezas Terminado", JOptionPane.INFORMATION_MESSAGE);
                 JOptionPane.showMessageDialog(new JPanel(), "El Sistema Solar consiste de 8 planetas", "Aprendizaje", JOptionPane.INFORMATION_MESSAGE);
