...
import static PuzzleMenu.Dificil.SistemaSolarDificil.PuzzleSistemaSolarDificil.id;
...
public class Figure extends JButton implements ActionListener{
	...
	private void Move(){
		...
		if(board[xPos][yPos-1].getFigure() == null){ // arriba
			...
			yPos --;
			PuzzleSistemaSolarDificil.board.Remover();
			ComprobarRespuesta();
			return;
	...
	private void ComprobarRespuesta(){
		...
		JOptionPane.showMessageDialog(new JPanel(), "Felicitaciones", "Rompecabezas Terminado", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(new JPanel(), "Hay 200 satelites naturales en nuestro sistema solar", "Aprendizaje", JOptionPane.INFORMATION_MESSAGE);
