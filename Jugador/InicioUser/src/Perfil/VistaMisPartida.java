...
public class VistaMisPartida extends javax.swing.JFrame {

    Partidas users= new Partidas();
    
    static int id;
    
    public VistaMisPartida(int id) {
        this.id=id;
        users.id=id;
        initComponents();
        tablageneral();
    ...
    private void initComponents() {
        ...
        Otros.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Menos Puntuacion", "Mas Puntuacion" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(VistaMisPartida.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaMisPartida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaMisPartida(id).setVisible(true);
            }
        });
    }
