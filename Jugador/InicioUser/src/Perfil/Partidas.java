...
public class Partidas extends JFrame{
    ...
    JTable tabla;
    int id;
    public ArrayList<ArrayMisPartidas> a=new ArrayList <>();
    ...
    public void Todo(){
        a.clear();
        String consultasql=("SELECT*FROM partidas WHERE usuario='"+id+"'");
        ...
        try{
            ...
            while(rs.next()){
                ...
                ArrayMisPartidas x=new ArrayMisPartidas(rs.getInt(1),b,c,rs.getInt(4));
                a.add(x);
    ...
    public void MenosPuntuacion(){
            ArrayMisPartidas comodin=new ArrayMisPartidas();
    ...
    public void Reporte(){
        ...
        try{
            ...
            Paragraph titulo= new Paragraph("Reporte de Partidas Usuario dia: "+date);
